...
export const events = {
    NewSubgraph: new LogEvent<([id: bigint, owner: string, displayName: string, imageUrl: string] & {id: bigint, owner: string, displayName: string, imageUrl: string})>(
        abi, '0x9ab3aefb2ba6dc12910ac1bce4692cf5c3c0d06cff16327c64a3ef78228b130b'
    ),
    UpdatedSubgraph: new LogEvent<([id: bigint, owner: string, displayName: string, imageUrl: string] & {id: bigint, owner: string, displayName: string, imageUrl: string})>(
